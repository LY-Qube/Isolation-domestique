                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pl-5">
                                ...
                                <p class="text-justify">
                                    ...
                                    sur vos factures d’énergie. Effectivement c’est une source de déperdition
                                ...
                                <p class="text-justify">
                                    Si vos combles sont facilement accessibles (trappe 60x60 minimum), la méthode
                                    choisie sera dite du « déroulé ». Comme son nom l’entend, il s’agit de dérouler de
                                    la laine isolante sur le sol de vos combles.
                                </p>
                                <p class="text-justify">
                                    Si vos combles ne sont pas facilement accessibles, la méthode choisie sera «
                                    l’isolation par soufflage ». Cette méthode d’isolation consiste à souffler de la
                                    laine. On souffle l’isolant jusque dans les moindres recoins sur plus de 32 cm
                                    d’épaisseur pour une isolation optimum, en veillant scrupuleusement à laisser
                                    votre pieuvre électrique bien apparente.
                                </p>
                                <p class="text-justify">
                                    Le matériel isolant doit être conforme aux normes imposées par le programme
                                    (coefficient de résistance thermique supérieur ou égal à 3 K/W m²).
                                </p>
                            </div>
                        </div>
                    </div>
